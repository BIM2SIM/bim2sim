...
class CreateTEASERModel(ITask):
    ...
    def run(self, workflow, libraries, ifc, instances, weather_file):
        self.logger.info("Start creating a TEASER model based on the BIM model")
        ...
        return teaser_prj, exported_buildings
