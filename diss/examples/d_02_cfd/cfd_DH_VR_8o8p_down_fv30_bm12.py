...
def run_example_18():
    ...
    project_path = Path(
        tempfile.TemporaryDirectory(prefix='d_VR8o8p_down_fv3b12_').name)
    ...
    project.sim_settings.outflow_direction = 'down'
    project.sim_settings.mesh_size = 0.12
    project.sim_settings.n_procs = 192
    ...
    project.sim_settings.people_amount = 8
