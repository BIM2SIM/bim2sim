...
def run_example_1():
    """Simple Case: No ratiation on heater, only convection, 30% heat on
    porous media (70% on heater surface).
    """
    ...
    # directory
    project_path = Path(
        tempfile.TemporaryDirectory(prefix='diss_cfd_FZK_noR_70_').name)
    ...
    project.sim_settings.heater_radiation = 0.7
