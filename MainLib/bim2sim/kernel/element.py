...
class ProductBased(IFCMixin, Root):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        # TODO: this will not work because init is called after new returns
        #  elements that know what they realy are after init should be replaced in factory method
...
class BaseLayer(RelationBased):
    pass


class BaseSpaceBoundary(RelationBased):
    pass
...
class SpaceBoundary(BaseSpaceBoundary):
    pass
...
class BPSIfcProductBased(IfcProductBased, BPSProduct):
    pass


class HVACIfcProductBased(IfcProductBased, HVACProduct):
...
# todo make this RelationBased class
...
# todo make this ProductBased HVAC and ProductBasedBPS
