...
## Examples
Please also take a look at `bim2sim/examples`, which provides some runnable generic examples. You can find plugin-specific examples in the examples directory of the respective plugin: `bim2sim/plugins/[PluginName]/[bim2sim_Name]/examples`.
