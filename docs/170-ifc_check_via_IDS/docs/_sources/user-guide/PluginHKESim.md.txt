...
`bim2sim/plugins/PluginHKESim/bim2sim_hkesim/examples`, which provides some
runnable examples for the HKESim plugin. You can use these examples to test your
