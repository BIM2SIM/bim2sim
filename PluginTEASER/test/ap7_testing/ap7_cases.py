...
from PluginTEASER.test.integration_test_setup import \
...
class IntegrationBaseTEASER(IntegrationBaseTeaserInteractive, unittest.TestCase):
    ...
    # @unittest.skip("Skipped for improved performance")
    def test_run_DigitalHub_spaces_low_layers_low(self):
    ...
    # @unittest.skip("Skipped for improved performance")
    def test_run_DigitalHub_spaces_medium_layers_low(self):
        """Run project with AC20-Institute-Var-2.ifc"""
        ifc = RESULT_PATH / 'FM_ARC_DigitalHub_fixed002.ifc'
    ...
    # @unittest.skip("Skipped for improved performance")
    def test_run_DigitalHub_spaces_full_layers_low(self):
        """Run project with AC20-Institute-Var-2.ifc"""
        ifc = RESULT_PATH / 'FM_ARC_DigitalHub_fixed002.ifc'
        used_workflow = workflow.BPSMultiZoneSeparatedLayersLow()
        project = self.create_project(ifc, 'TEASER', used_workflow)
        answers = ('ARCHICAD-64', *(None,) * 150, True, True,
                   2015, 'light', 'Waermeschutzverglasung, dreifach')
        handler = DebugDecisionHandler(answers)
